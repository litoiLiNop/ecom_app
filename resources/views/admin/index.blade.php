...
<div class="page-content">
					...
					<div class="row row-cols-1 row-cols-md-2 row-cols-xl-4">
							...
							<div class="card radius-10 bg-gradient-deepblue">
							 <div class="card-body">
								<div class="d-flex align-items-center">
									<h5 class="mb-0 text-white">{{ $today }} Fcfa</h5>
									<div class="ms-auto">
						...
						<div class="col">
							...
							<div class="card-body">
								<div class="d-flex align-items-center">
									<h5 class="mb-0 text-white">{{ $month }} Fcfa</h5>
									<div class="ms-auto">
                                        <i class='bx bx-cart fs-3 text-white'></i>
									</div>
								</div>
						...
						<div class="col">
							...
							<div class="card-body">
								<div class="d-flex align-items-center">
									<h5 class="mb-0 text-white">{{ $year }} Fcfa</h5>
									<div class="ms-auto">
                                        <i class='bx bx-cart fs-3 text-white'></i>
									</div>
								</div>
								...
								<div class="d-flex align-items-center text-white">
									<p class="mb-0">Vente de l'année</p>
