...
@endsection
 ...
 <p>Il y a <strong class="text-brand">{{ count($products) }}</strong> articles pour toi!</p>
                        </div>
                            ...
                            <div class="sort-by-cover">
                                ...
                                <div class="sort-by-dropdown">
                                    <ul>
                                        ...
                                        <li><a href="#">Prix: Low to High</a></li>
                                        <li><a href="#">Prix: High to Low</a></li>
                                        <li><a href="#"> Date</a></li>
...
@endphp
        ...
        @endforeach
                    ...
                    <div class="sidebar-widget product-sidebar mb-30 p-30 bg-grey border-radius-10">
                        <h5 class="section-title style-1 mb-30">Nouveaux</h5>
