                                ...
                                <div class="d-flex justify-content-between align-items-end mb-30">
                                    <div>
                                        <div class="product-category">
                                            <span class="text-muted">Depuis {{ $vendor->vendor_join }}</span>
                                        </div>
              ...
              @endphp
                                ...
                                <div class="vendor-info mb-30">
                                    <ul class="contact-infor text-muted">
                                        ...
                                        <li><img src="{{ asset('frontend/assets/imgs/theme/icons/icon-contact.svg') }}" alt="" /><strong>Appel:</strong><span>{{ $vendor->phone }}</span></li>
                                    </ul>
                                </div>
