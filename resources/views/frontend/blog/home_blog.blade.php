                            ...
                            <div class="sort-by-product-area">
                                ...
                                <div class="sort-by-cover">
                                    <div class="sort-by-product-wrap">
                                        ...
                                        <div class="sort-by-dropdown-wrap">
                                            <span>A la Une <i class="fi-rs-angle-small-down"></i></span>
                                        </div>
                                    </div>
                                    <div class="sort-by-dropdown">
                                        <ul>
                                            <li><a class="active" href="#">A La Une</a></li>
...
<article class="wow fadeIn animated hover-up mb-30 animated">
    ...
    <div class="entry-content-2 pl-50">
        ...
        <div class="entry-meta meta-1 font-xs color-grey mt-10 pb-10">
            ...
            <a href="{{ url('post/details/'.$post->id.'/'.$post->post_slug) }}" class="text-brand font-heading font-weight-bold">En savoir plus <i class="fi-rs-arrow-right"></i></a>
        </div>
    </div>
</article>
            @endforeach
            ...
            @endforeach
                            ...
                            <div class="banner-img wow fadeIn mb-50 animated d-lg-block d-none">
                                ...
                                <div class="banner-text">
                                    ...
                                    <h4>
                                        Save 17% <br />
                                        on <span class="text-brand">Jus Organique</span><br />
