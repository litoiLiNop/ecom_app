...
<ul class="contact-infor">
    ...
    <li><img src="{{ asset('frontend/assets/imgs/theme/icons/icon-clock.svg') }}" alt="" /><strong>Hours: </strong><span>10:00 - 18:00, Lun - Sam</span></li>
</ul>
                        </div>
                    </div>
        ...
        <div class="container pb-30 wow animate__animated animate__fadeInUp" data-wow-delay="0">
            <div class="row align-items-center">
                ...
                <div class="col-xl-4 col-lg-6 col-md-6">
                    ...
                    <p class="font-sm mb-0">&copy; <strong class="text-brand">eBoutiQ</strong> - {{ $setting->copyright }}  </p>
                </div>
