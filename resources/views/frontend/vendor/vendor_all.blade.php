        ...
        <div class="page-content pt-50">
            <div class="container">
                <div class="archive-header-2 text-center">
                    <h1 class="display-2 mb-50"> Toutes les Boutiques</h1>
                    <div class="row">
                        <div class="col-lg-5 mx-auto">
                            <div class="sidebar-widget-2 widget_search mb-50">
                                <div class="search-form">
                                    <form action="#">
                                        <input type="text" placeholder="Recherche Vendeurs (le name ou ID)..." />
                    ...
                    <div class="col-12 col-lg-8 mx-auto">
                        <div class="shop-product-fillter">
                            <div class="totall-product">
                                <p>Nous avons <strong class="text-brand">{{ count($vendors) }} </strong>vendeurs présentement</p>
                            </div>
   ...
   <span class="font-small total-product">{{ count($products) }} products</span>
                                ...
                                <div class="vendor-info mb-30">
                                    <ul class="contact-infor text-muted">
                                        ...
                                        <li><img src="assets/imgs/theme/icons/icon-contact.svg" alt="" /><strong>Appel:</strong><span>{{ $vendor->phone }}</span></li>
                                    </ul>
                                </div>
                                <a href="{{ route('vendor.details',$vendor->id) }}" class="btn btn-xs">Visiter la Boutique <i class="fi-rs-arrow-small-right"></i></a>
                            </div>
                        </div>
                    </div>
                    <!--end vendor card-->
