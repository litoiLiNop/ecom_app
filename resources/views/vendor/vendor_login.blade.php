...
<body class="bg-login">
    ...
    <div class="form-body">
        ...
        <form class="row g-3" method="POST" action="{{ route('login') }}">
            ...
            <div class="col-12">
                <label for="inputEmailAddress" class="form-label">Addresse Email</label>
            ...
            <div class="col-12">
                <div class="d-grid">
                    <button type="submit" class="btn btn-primary"><i class="bx bxs-lock-open"></i>Se connnecter</button>
                </div>
            </div>
        </form>
    </div>
