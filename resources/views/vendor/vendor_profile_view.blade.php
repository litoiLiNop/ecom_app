...
<div class="page-content">
				...
				<div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
					<div class="breadcrumb-title pe-3">Profil Utilisateur Dépot </div>
					<div class="ps-3">
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb mb-0 p-0">
								<li class="breadcrumb-item"><a href="javascript:;"><i class="bx bx-home-alt"></i></a>
								</li>
								<li class="breadcrumb-item active" aria-current="page"> Profil Dépot</li>
							</ol>
						</nav>
					</div>
					<div class="ms-auto">
...
<div class="col-lg-8">
	<div class="card">
		...
		<form method="post" action="{{ route('vendor.profile.store') }}" enctype="multipart/form-data" >
			...
			<div class="row mb-3">
				<div class="col-sm-3">
					<h6 class="mb-0">Date de Souscription</h6>
				</div>
				<div class="col-sm-9 text-secondary">
					<select name="vendor_join" class="form-select mb-3" aria-label="Default select example" id="">
			...
			<div class="row mb-3">
				<div class="col-sm-3">
					<h6 class="mb-0">Info Dépot</h6>
				</div>
				<div class="col-sm-9 text-secondary">
					<textarea name="vendor_short_info" class="form-control" id="inputAddress2" placeholder="Intro du Dépot..." rows="3">{{ $vendorData->vendor_short_info }}</textarea>
				</div>
			</div>
