    ...
    <div class="login_wrap widget-taber-content background-white">
        <div class="padding_eight_all bg-white">
            <div class="heading_s1">
                ...
                <p class="mb-30">Vous n'avez pas de compte ? <a href="page-register.html">Inscription</a></p>
            </div>
           ...
           <form method="POST" action="{{ route('login') }}">
            @csrf
                ...
                <div class="form-group">
                    <input type="email" id="email"  required="" name="email" placeholder="Utilisateur *" />
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <button type="submit" class="btn btn-heading btn-block hover-up" name="login">Se connecter</button>
                </div>
            </form>
        </div>
    </div>
