...
<head>
    <meta charset="utf-8" />
    <title>Réinitialisation Mot de passe - eBoutiQ </title>
                    ...
                    <div class="col-xl-6 col-lg-8 col-md-12 m-auto">
                        <div class="row">
                            <div class="heading_s1">
                                ...
                                <h2 class="mb-15 mt-15">Réinitialiser Le Mot de Passe</h2>
    ...
    <div class="login_wrap widget-taber-content background-white">
        <div class="padding_eight_all bg-white">
            ...
            @csrf
                ...
                <div class="form-group">
                    <button type="submit" class="btn btn-heading btn-block hover-up" name="login">Lien pour réinitialiser</button>
                </div>
            </form>
                                    </div>
                                </div>
