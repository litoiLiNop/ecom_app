...
<div class="page-content">
				...
				<div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
					<div class="breadcrumb-title pe-3">Détails de Vendeur inactif</div>
					<div class="ps-3">
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb mb-0 p-0">
								<li class="breadcrumb-item"><a href="javascript:;"><i class="bx bx-home-alt"></i></a>
								</li>
								<li class="breadcrumb-item active" aria-current="page">Détails de Vendeur inactif</li>
							</ol>
						</nav>
					</div>
					<div class="ms-auto">
...
<div class="col-lg-12">
	<div class="card">
		...
		<input type="hidden" name="id" value="{{ $inactiveVendorDetails->id }}">
			...
			<div class="row mb-3">
				<div class="col-sm-3">
					<h6 class="mb-0">Infos du Vendeur</h6>
				</div>
				<div class="col-sm-9 text-secondary">
			...
			<div class="row">
				...
				<div class="col-sm-9 text-secondary">
					<input type="submit" class="btn btn-danger px-4" value="Activer" />
				</div>
			</div>
		</div>
