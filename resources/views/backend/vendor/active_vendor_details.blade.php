...
<div class="page-content">
				...
				<div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
					<div class="breadcrumb-title pe-3">Détails de Vendeur actif</div>
					<div class="ps-3">
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb mb-0 p-0">
								<li class="breadcrumb-item"><a href="javascript:;"><i class="bx bx-home-alt"></i></a>
								</li>
								<li class="breadcrumb-item active" aria-current="page">Détails de Vendeur actif</li>
							</ol>
						</nav>
					</div>
					<div class="ms-auto">
	...
	<div class="card">
		...
		<input type="hidden" name="id" value="{{ $activeVendorDetails->id }}">
			...
			<div class="row">
				...
				<div class="col-sm-9 text-secondary">
					<input type="submit" class="btn btn-danger px-4" value="Désactiver" />
				</div>
			</div>
		</div>
