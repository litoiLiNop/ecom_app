...
<div class="col-lg-8">
	<div class="card">
		...
		<form id="adForm" method="post" action="{{ route('admin.user.store') }}"  >
			@csrf
			...
			<div class="row mb-3">
				...
				<div class="col-sm-9 text-secondary">
					<input type="text" name="phone" class="form-control" placeholder=" Numéro de télephone" />
				</div>
			</div>
			...
			<div class="row mb-3">
				...
				<div class="col-sm-9 text-secondary">
					<input type="text" name="address" class="form-control" placeholder="Ajout addresse" />
				</div>
			</div>
			...
			<div class="row mb-3">
				<div class="col-sm-3">
					<h6 class="mb-0">Assigner un Rôle </h6>
				</div>
				<div class="col-sm-9 text-secondary">
