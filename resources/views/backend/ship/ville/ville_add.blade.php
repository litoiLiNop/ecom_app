					...
					<div class="ps-3">
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb mb-0 p-0">
								...
								<li class="breadcrumb-item active" aria-current="page">Ajout Ville </li>
							</ol>
						</nav>
					</div>
					<div class="ms-auto">
...
<div class="col-lg-10">
 ...
 <form id="myForm" method="post" action="{{ route('store.ville') }}"   >
			@csrf
	 	...
	 	<select name="region_id" class="form-select mb-3" aria-label="Default select example">
           ...
           <div class="row mb-3">
				...
				<div class="form-group col-sm-9 text-secondary">
					<input type="text" name="ville_name" class="form-control"   />
				</div>
			</div>
...
<script type="text/javascript">
    $(document).ready(function (){
        $('#myForm').validate({
            ...
            messages :{
                ville_name: {
                    required : 'Bien vouloir renseigner le nom de la ville',
                },
            },
            errorElement : 'span',
