					...
					<div class="ps-3">
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb mb-0 p-0">
								...
								<li class="breadcrumb-item active" aria-current="page">Attribution de Permission </li>
							</ol>
						</nav>
					</div>
					<div class="ms-auto">
...
<div class="col-lg-10">
    ...
    <div class="form-check">
        ...
        <label class="form-check-label" for="flexCheckDefaultAll">Toutes les Permissions</label>
    </div>
