...
<div class="page-content">
				...
				<div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
					<div class="breadcrumb-title pe-3">Gestion Rôles & Permissions </div>
					<div class="ps-3">
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb mb-0 p-0">
								<li class="breadcrumb-item"><a href="javascript:;"><i class="bx bx-home-alt"></i></a>
								</li>
								<li class="breadcrumb-item active" aria-current="page">Ajout Roles Permission</li>
							</ol>
						</nav>
					</div>
					<div class="ms-auto">
...
<div class="form-check">
	...
	<label class="form-check-label" for="flexCheckDefaultAll">Permissions</label>
</div>
