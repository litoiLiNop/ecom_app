...
class VendorController extends Controller
{
    ...
    public function VendorProfile()
    {
        ...
        $id = Auth::user()->id; //which user is login as a $id variable
        $vendorData = User::find($id); // getting the authenticated user's data
    ...
    public function VendorProfileStore(Request $request)
    {
        ...
        $notification = array(
            'message' => 'Profil Dépot Mis à jour!',
            'alert-type' => 'success'
        );
    ...
    public function VendorRegister(Request $request)
    {
        ...
        $notification = array(
            'message' => 'Point de vente enregistré',
            'alert-type' => 'success'
        );
